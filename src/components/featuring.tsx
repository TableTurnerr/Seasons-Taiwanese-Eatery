...
import Popcorn_Chicken from "@/../public/Images/Popcorn_Chicken.webp";
...
function Featuring() {
	...
	return (
		<div className="w-full">
			...
			>
				<div className="text-center text-h2 text-black mb-12 md:mb-[80px]">
					<div className="">Featuring</div>
					<div className="text-normal2 sm:text-h5 mt-1 mx-2x">
						Food that’s Healthy AND Satisfies Your Cravings
					</div>
				</div>

				<div className="grid grid-cols-2 gap-x-4 gap-y-8 md:flex md:justify-between md:items-center md:gap-0 self-stretch group">
					<div className="flex flex-col items-center gap-[10px] w-full">
						<div className="h-[22px] w-[22px] aspect-square text-grey">
							<svg
						...
						<div className="text-normal3 text-center">
							Gluten-Free Options
						</div>
					</div>
					<div className="h-[80px] w-[1px] bg-black hidden md:block group-hover:rotate-8 transition-all duration-300"></div>
					<div className="flex flex-col items-center gap-[10px] w-full">
						<div className="h-[22px] w-[22px] aspect-square text-grey">
							<svg
								xmlns="http://www.w3.org/2000/svg"
			...
			>
				<div className="mx-auto w-full max-w-[1240px] flex flex-col lg:flex-row lg:justify-between items-center gap-8 lg:gap-0">
					<Image
						...
						width={540}
						height={540}
						priority // Add priority if visible early
					...
					<div className="flex w-full lg:w-fit max-w-[560px] flex-col items-center lg:items-start gap-[10px] md:gap-[20px] mt-8 lg:mt-0 lg:ml-5">
						<div
							className={`self-stretch ${isSmallMobile ? "text-h4 font-[600] leading-none" : "text-h3 xl:text-h2"}  text-black text-center lg:text-left`}
						>
							Popcorn Chicken
						</div>
						<div className="text-normal4 md:text-normal3 text-grey text-center lg:text-left">
							Crispy, golden Taiwanese-style chicken bites tossed
							with fragrant basil.
						</div>
					</div>
				</div>
			...
			{/* Featured Dish Section 2 */}
			<motion.div // Wrap section in motion.div
				className="mt-[100px] px-4 lg:px-[80px]"
				initial="hidden"
				whileInView="visible"
			...
			>
				<div className="mx-auto w-full max-w-[1240px] flex flex-col lg:flex-row lg:justify-between items-center gap-8 lg:gap-0">
					...
					<div className="flex w-full lg:w-fit max-w-[560px] flex-col items-center lg:items-start gap-[10px] md:gap-[20px] mt-8 lg:mt-0 lg:mr-5">
						<div
							className={`${isSmallMobile ? "text-h4 font-[600] leading-none" : "text-h3 xl:text-h2"} self-stretch text-h3 xl:text-h2 lg:text-h2 text-black text-center lg:text-left`}
						>
							Boiled Dumplings
						</div>
						<div className="text-normal4 md:text-normal3 text-grey text-center lg:text-left">
							Soft, juicy dumplings filled with seasoned meat — a
							classic Taiwanese bite that’s simple, hearty, and
							loved in Hawaii.
						</div>
					</div>
					<Image
			...
			>
				<div className="mx-auto w-full max-w-[1240px] flex flex-col lg:flex-row lg:justify-between items-center gap-8 lg:gap-0">
					...
					<div className="flex w-full lg:w-fit max-w-[560px] flex-col items-center lg:items-start gap-[10px] md:gap-[20px] mt-8 lg:mt-0 lg:ml-5">
						<div
							className={`${isSmallMobile ? "text-h4 font-[600] leading-none" : "text-h3 xl:text-h2"} self-stretch text-h3 xl:text-h2 text-black text-center lg:text-left`}
						>
							Beef noodle soup
						</div>
						<div className="text-normal4 md:text-normal3 text-grey text-center lg:text-left">
							Tender braised beef shank in a rich, aromatic broth
							with noodles — Taiwan’s national dish. Slow-cooked
							for depth, served with a kick of house chili crisp
							for those who dare.
						</div>
					</div>
				</div>
      ...
      >
        <div className='mx-auto w-full max-w-[1240px] flex flex-col lg:flex-row lg:justify-between items-center gap-8 lg:gap-0'>
          <Image
            ...
            alt="Family Tradition" // Changed alt text
          ...
          <div className='flex w-full lg:w-fit max-w-[560px] flex-col items-center lg:items-start gap-[10px] md:gap-[20px] mt-8 lg:mt-0 lg:ml-5'>
            ...
            Seasons Taiwanese Eatery (绣蘭竹苑) is a family-run restaurant in Honolulu, Hawaii, known for serving real, traditional Taiwanese food.
            <br /><br />
            Since opening in 1994, it’s been a local favorite, offering dishes like beef noodle soup, popcorn chicken, and popular Taiwanese street food.
            <br /><br />
            Now run by the second generation, the restaurant continues the family’s food traditions. Their ingredients are locally sourced, supporting Hawaii’s local suppliers.
            <br /><br />
            Brian Wang, the current owner, took over six years ago. He’s added both well-known and unique Taiwanese dishes, mixing family recipes with his own cooking experience from Taiwan and Sichuan.
            </div>
          </div>
          <Image
            src={family_tradition} // Family Tradition Image
      ...
      >
        <div className='mx-auto w-full max-w-[1240px] flex flex-col lg:flex-row lg:justify-between items-center gap-8 lg:gap-0'>
           <Image
            ...
            width={540} height={540}
            className='block lg:hidden w-full h-auto shrink-0 rounded-[24px] object-cover'
          />
          <div className='flex w-full lg:w-fit max-w-[560px] flex-col items-center lg:items-start gap-[10px] md:gap-[20px] mt-8 lg:mt-0 lg:mr-5'>
            <div className='self-stretch text-h3 xl:text-h2 text-black text-center lg:text-left'>
              Community
            ...
            <div className='text-normal4 xl:text-normal3 text-grey text-center lg:text-left'>
              Seasons Taiwanese Eatery Gives Back 10% To Help Your Non-Profit
              <br /><br />
              Do you have an organization that needs to do fundraising? We’d love to help, and when you hold your event with us, we’ll give back 10% of our net sales for that event to your organization.
              <br /><br />
              Simply contact Sandy to arrange a day to host your event, then have your supporters bring in the event flyer and we’ll send your organization 10% of the net sales. Schedule your event date between November 1st, 2015 and May 15, 2016. It’s that easy!
              <br /><br />
              Thank You!
           ...
           <Image
            ...
            alt="Community Fundraising" 
            width={540} height={540}
            className='hidden lg:block w-full h-auto lg:w-[400px] lg:h-[400px] xl:w-[540px] xl:h-[540px] shrink-0 rounded-[24px] object-cover'
          />
        </div>
      </motion.div> */}
		</div>
