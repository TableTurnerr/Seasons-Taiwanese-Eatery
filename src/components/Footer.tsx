	...
	return (
		<div className=" mb-[10px]">
			...
			<footer className="bg-white text-black w-full px-[10px] md:px-[50px] lg:px-[70px]">
				...
				<div className="mb-[32px] mx-2 text-grey text-normal2">
					Seasons Taiwanese Eatery is a beloved family-run restaurant
					in Honolulu, serving authentic Taiwanese food since 1994 —
					from crispy popcorn chicken to rich beef noodle soup, it's
					where locals go to satisfy real Taiwanese cravings.
				</div>
						...
						<div className="col-span-2 lg:col-span-1 mx-auto flex flex-row items-center lg:items-start gap-4">
							...
							<div className="flex sm:max-h-[180px] justify-evenly gap-[10px] flex-row sm:flex-col my-auto max-w-[100px]">
								<a
									...
									className="bg-black/[0.07] sm:min-w-[100px] p-2 sm:py-4 h-full w-full items-center justify-center flex rounded-lg hover:opacity-80 transition-opacity"
								>
									<svg
								...
								<a
									...
									aria-label="Facebook"
									className="bg-black/[0.07] p-2 px-3 sm:py-4 h-full w-full items-center justify-center flex rounded-lg hover:opacity-80 transition-opacity"
								>
									<svg
										xmlns="http://www.w3.org/2000/svg"
										width="12"
								...
								<a
									...
									aria-label="Facebook"
									className="bg-black/[0.07] p-2 sm:py-4 h-full w-full items-center justify-center flex rounded-lg hover:opacity-80 transition-opacity"
								>
									<svg
										width="24"
										height="24"
      ...
      c8.617-0.596,19.388,7.104,26.447,11.138c9.396,5.409,19.48,11.596,26.492,20.076C100.159,131.862,101.03,132.916,101.397,134.566z"
						...
						<div className="col-span-1 sm:col-span-2 flex flex-row justify-evenly w-full mb-8 lg:mb-0">
							...
							<div className="col-span-1 text-center h-full lg:mr-10 mr-0">
								<div className="flex h-full flex-col items-center justify-center">
									...
									<div className="text-normal4 text-black/80">
										...
										<div>contact@seasonseateryhi.com</div>
									</div>
								</div>
							</div>
							...
							<div
								className={`col-span-1 text-center h-full ${isSmallMobile ? "hidden" : ""}`}
							>
								<div className="flex h-full flex-col items-center justify-center">
									<div className="text-h5 font-semibold mb-[22px]">
										Quick Links
				...
				<div className="bg-primary rounded-full text-white w-[90%] mx-auto min-h-[37px] py-[10px] sm:px-[50px] md:px-[100px]">
					<div className="container mx-auto flex flex-col sm:flex-row justify-between items-center text-center text-normal4 gap-[20px]">
						<p className="hidden sm:block">
							Seasons Taiwanese Eatery Inc. 2025 All Rights
							Reserved
						</p>
				...
				<div className="w-full justify-center items-center text-center text-[10px] mt-1 flex sm:hidden">
